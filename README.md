...
GitHub Repositories
	...
	->Producer Service : https://github.com/SurajMadhushan/kafka-producer-service.git

	->Consumer Service : https://github.com/SurajMadhushan/kafka-consumer-service.git

	->Frontend Dashboard (React Vite) : https://github.com/SurajMadhushan/kafka-react-frontend.git
...
Kafka Setup (KRaft Mode)
	...
	->Generate Cluster ID : bin/windows/kafka-storage.bat random-uuid


	->Format storage : bin/windows/kafka-storage.bat format -t <CLUSTER_ID> -c config/kraft/server.properties
